...
public class LogicalOperations {
    ...
    public static String permutation8var1(String input, String u) {
    ...
    public static String permutation8var2(String input, String u) {
        String uExt = extend8(u, u);
        String output = "";

        int b0 = 
        toInt(input.charAt(0)) * not(toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(10))) + 
        toInt(input.charAt(1)) * (toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(10))) + 
        toInt(input.charAt(2)) * (toInt(uExt.charAt(1))) * (toInt(uExt.charAt(4))) * (toInt(uExt.charAt(10))) + 
        toInt(input.charAt(3)) * not(toInt(uExt.charAt(1))) * (toInt(uExt.charAt(4))) * (toInt(uExt.charAt(10))) + 
        toInt(input.charAt(4)) * not(toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(4))) * (toInt(uExt.charAt(10))) + 
        toInt(input.charAt(5)) * (toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(4)) ) * (toInt(uExt.charAt(10))) +  
        toInt(input.charAt(6)) * (toInt(uExt.charAt(3))) * (toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(10))) +  
        toInt(input.charAt(7)) * not(toInt(uExt.charAt(3))) * (toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(10)));

        int b1 = 
        toInt(input.charAt(0)) * (toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(11))) + 
        toInt(input.charAt(1)) * not(toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(11))) + 
        toInt(input.charAt(2)) * not(toInt(uExt.charAt(1))) * (toInt(uExt.charAt(6))) * (toInt(uExt.charAt(11))) + 
        toInt(input.charAt(3)) * (toInt(uExt.charAt(1))) * (toInt(uExt.charAt(6))) * (toInt(uExt.charAt(11))) + 
        toInt(input.charAt(4)) * (toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(6))) * (toInt(uExt.charAt(11))) + 
        toInt(input.charAt(5)) * not(toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(6)) ) * (toInt(uExt.charAt(11))) +  
        toInt(input.charAt(6)) * not(toInt(uExt.charAt(3))) * (toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(11))) +  
        toInt(input.charAt(7)) * (toInt(uExt.charAt(3))) * (toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(11)));

        int b2 = 
        toInt(input.charAt(0)) * (toInt(uExt.charAt(0))) * (toInt(uExt.charAt(7))) * (toInt(uExt.charAt(8))) + 
        toInt(input.charAt(1)) * not(toInt(uExt.charAt(0))) * (toInt(uExt.charAt(7))) * (toInt(uExt.charAt(8))) + 
        toInt(input.charAt(2)) * not(toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(6))) * not(toInt(uExt.charAt(8))) + 
        toInt(input.charAt(3)) * (toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(6))) * not(toInt(uExt.charAt(8))) + 
        toInt(input.charAt(4)) * (toInt(uExt.charAt(2))) * (toInt(uExt.charAt(6))) * not(toInt(uExt.charAt(8))) + 
        toInt(input.charAt(5)) * not(toInt(uExt.charAt(2))) * (toInt(uExt.charAt(6)) ) * not(toInt(uExt.charAt(8))) +  
        toInt(input.charAt(6)) * not(toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(7))) * (toInt(uExt.charAt(8))) +  
        toInt(input.charAt(7)) * (toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(7))) * (toInt(uExt.charAt(8)));

        int b3 = 
        toInt(input.charAt(0)) * not(toInt(uExt.charAt(0))) * (toInt(uExt.charAt(5))) * (toInt(uExt.charAt(9))) + 
        toInt(input.charAt(1)) * (toInt(uExt.charAt(0))) * (toInt(uExt.charAt(5))) * (toInt(uExt.charAt(9))) + 
        toInt(input.charAt(2)) * (toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(4))) * not(toInt(uExt.charAt(9))) + 
        toInt(input.charAt(3)) * not(toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(4))) * not(toInt(uExt.charAt(9))) + 
        toInt(input.charAt(4)) * not(toInt(uExt.charAt(2))) * (toInt(uExt.charAt(4))) * not(toInt(uExt.charAt(9))) + 
        toInt(input.charAt(5)) * (toInt(uExt.charAt(2))) * (toInt(uExt.charAt(4)) ) * not(toInt(uExt.charAt(9))) +  
        toInt(input.charAt(6)) * (toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(5))) * (toInt(uExt.charAt(9))) +  
        toInt(input.charAt(7)) * not(toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(5))) * (toInt(uExt.charAt(9)));

        int b4 = 
        toInt(input.charAt(0)) * not(toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(5))) * (toInt(uExt.charAt(10))) + 
        toInt(input.charAt(1)) * (toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(5))) * (toInt(uExt.charAt(10))) + 
        toInt(input.charAt(2)) * (toInt(uExt.charAt(1))) * (toInt(uExt.charAt(4))) * not(toInt(uExt.charAt(10))) + 
        toInt(input.charAt(3)) * not(toInt(uExt.charAt(1))) * (toInt(uExt.charAt(4))) * not(toInt(uExt.charAt(10))) + 
        toInt(input.charAt(4)) * not(toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(4))) * not(toInt(uExt.charAt(10))) + 
        toInt(input.charAt(5)) * (toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(4)) ) * not(toInt(uExt.charAt(10))) +  
        toInt(input.charAt(6)) * (toInt(uExt.charAt(3))) * (toInt(uExt.charAt(5))) * (toInt(uExt.charAt(10))) +  
        toInt(input.charAt(7)) * not(toInt(uExt.charAt(3))) * (toInt(uExt.charAt(5))) * (toInt(uExt.charAt(10)));

        int b5 = 
        toInt(input.charAt(0)) * (toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(7))) * (toInt(uExt.charAt(11))) + 
        toInt(input.charAt(1)) * not(toInt(uExt.charAt(0))) * not(toInt(uExt.charAt(7))) * (toInt(uExt.charAt(11))) + 
        toInt(input.charAt(2)) * not(toInt(uExt.charAt(1))) * (toInt(uExt.charAt(6))) * not(toInt(uExt.charAt(11))) + 
        toInt(input.charAt(3)) * (toInt(uExt.charAt(1))) * (toInt(uExt.charAt(6))) * not(toInt(uExt.charAt(11))) + 
        toInt(input.charAt(4)) * (toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(6))) * not(toInt(uExt.charAt(11))) + 
        toInt(input.charAt(5)) * not(toInt(uExt.charAt(2))) * not(toInt(uExt.charAt(6)) ) * not(toInt(uExt.charAt(11))) +  
        toInt(input.charAt(6)) * not(toInt(uExt.charAt(3))) * (toInt(uExt.charAt(7))) * (toInt(uExt.charAt(11))) +  
        toInt(input.charAt(7)) * (toInt(uExt.charAt(3))) * (toInt(uExt.charAt(7))) * (toInt(uExt.charAt(11)));

        int b6 = 
        toInt(input.charAt(0)) * (toInt(uExt.charAt(0))) * (toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(8))) + 
        toInt(input.charAt(1)) * not(toInt(uExt.charAt(0))) * (toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(8))) + 
        toInt(input.charAt(2)) * not(toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(6))) * (toInt(uExt.charAt(8))) + 
        toInt(input.charAt(3)) * (toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(6))) * (toInt(uExt.charAt(8))) + 
        toInt(input.charAt(4)) * (toInt(uExt.charAt(2))) * (toInt(uExt.charAt(6))) * (toInt(uExt.charAt(8))) + 
        toInt(input.charAt(5)) * not(toInt(uExt.charAt(2))) * (toInt(uExt.charAt(6)) ) * (toInt(uExt.charAt(8))) +  
        toInt(input.charAt(6)) * not(toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(8))) +  
        toInt(input.charAt(7)) * (toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(7))) * not(toInt(uExt.charAt(8)));

        int b7 = 
        toInt(input.charAt(0)) * not(toInt(uExt.charAt(0))) * (toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(9))) + 
        toInt(input.charAt(1)) * (toInt(uExt.charAt(0))) * (toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(9))) + 
        toInt(input.charAt(2)) * (toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(4))) * (toInt(uExt.charAt(9))) + 
        toInt(input.charAt(3)) * not(toInt(uExt.charAt(1))) * not(toInt(uExt.charAt(4))) * (toInt(uExt.charAt(9))) + 
        toInt(input.charAt(4)) * not(toInt(uExt.charAt(2))) * (toInt(uExt.charAt(4))) * (toInt(uExt.charAt(9))) + 
        toInt(input.charAt(5)) * (toInt(uExt.charAt(2))) * (toInt(uExt.charAt(4)) ) * (toInt(uExt.charAt(9))) +  
        toInt(input.charAt(6)) * (toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(9))) +  
        toInt(input.charAt(7)) * not(toInt(uExt.charAt(3))) * not(toInt(uExt.charAt(5))) * not(toInt(uExt.charAt(9)));
